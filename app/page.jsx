    ...
    <main>
      ...
      <section className="spread-workspace" id="spread-arbitrage">
        <div className="section-head">
          ...
          <div className="configured">当前绝对可执行价差 &gt; 0.5%，且相对 24h 时间加权基准偏离 &gt; 0.5%</div>
        </div>
        ...
        <div className="spread-list">
          {!loading && !error && spreadRows.length === 0 && <div className="state compact">当前没有同时满足绝对价差和加权偏离门槛的共同合约</div>}
